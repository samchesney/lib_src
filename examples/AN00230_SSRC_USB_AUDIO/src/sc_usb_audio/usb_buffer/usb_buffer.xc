            ...
            )
{
    ...
    unsigned long long clock_remainder = 0;        //This is the carry term from the 147/160 or 160/147 calc
    ...
    while(1)
    {
        ...
        select
        {
            ...
            //Extra case to handle receiving physical MCLK value on pins
#if SSRC_DEMO
...
#if SSRC_DEMO
                    if      (host_48 && !i2s_48){
                        clock_remainder += (full_result * 160) % 147;
                        full_result = (full_result * 160) / 147; //22.5792->24.576
                        ...
                        clock_remainder += (full_result * 147) % 160;
                        full_result = (full_result * 147) / 160; //24.576->22.5792
                        ...
                        full_result = full_result;   //Do nothing because we are one the same mclk
                        clock_remainder = 0;
                    }
